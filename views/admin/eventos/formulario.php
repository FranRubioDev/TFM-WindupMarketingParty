<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea class="formulario__input" id="descripcion" name="descripcion" placeholder="Descripción Evento" rows="6"><?php echo $evento->descripcion; ?></textarea>
    </div>
